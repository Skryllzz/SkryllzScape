...
public class Trapdoor {
    ...
    public static void open(Player player, GameObject trapdoor) {
    ...
    private static void climbDown(Player player) {
        ...
        } else if (player.isAt(3405, 3506)) {
            player.sendMessage("You climb down through the trapdoor..");
            Ladder.climb(player, 3405, 9906, 0, false, true, false);
        } else if (player.isAt(3423, 3485)) {
            player.sendMessage("You climb down through the trapdoor..");
    ...
    public static void register() {
         ...
         * Lumbridge
         */
        ObjectAction.register(14880, "climb-down", (player, obj) -> player.getMovement().teleport(3210, 9616, 0));
    }
