...
public enum PickPocket {
    ...
    MAN(1, 8.0, 422, 5, 1, "man's", PlayerCounter.PICKPOCKETED_MAN,
            new LootTable().addTable(1,
                    new LootItem(COINS_995, 3, 5, 1)  //Coins
            )),
    FARMER(10, 14.5, 433, 5, 1, "farmer's", PlayerCounter.PICKPOCKETED_FARMER,
            new LootTable().addTable(1,
                    new LootItem(COINS_995, 9, 15, 6), //Coins
    ...
    WARRIOR(25, 26.0, 386, 5, 2, "warrior's", PlayerCounter.PICKPOCKETED_WARRIOR,
            new LootTable().addTable(1,
                    new LootItem(COINS_995, 18, 25, 1) //Coins
            )),
    VILLAGER(30, 8.0, 386, 5, 2, "villager's", PlayerCounter.PICKPOCKETED_WARRIOR,
            new LootTable().addTable(1,
                    new LootItem(COINS_995, 18, 25, 1) //Coins
            )),
    ROGUE(32, 36.5, 422, 5, 2, "rogue's", PlayerCounter.PICKPOCKETED_ROGUE,
            new LootTable().addTable(1,
                    new LootItem(COINS_995, 25, 50, 10), //Coins
    ...
    GUARD(40, 46.8, 386, 5, 2, "guard's", PlayerCounter.PICKPOCKETED_GUARD,
            new LootTable().addTable(1,
                    new LootItem(COINS_995, 30, 50, 1) //Coins
            )),
    FREMENNIK(45, 45, 386, 5, 2, "fremennik citizen's", PlayerCounter.PICKPOCKETED_GUARD,
            new LootTable().addTable(1,
                    new LootItem(COINS_995, 40, 60, 1) //Coins
            )),
    BANDIT(53, 79.5, 422, 5, 3, "desert bandit's", PlayerCounter.PICKPOCKETED_BANDIT,
            new LootTable().addTable(1,
                    new LootItem(COINS_995, 30, 70, 8), //Coins
                    new LootItem(175, 1, 3),  //Antipoison
                    new LootItem(1523, 1, 1)  //Lockpick
            )),
    KNIGHT(55, 84.3, 386, 5, 3, "knight's", PlayerCounter.PICKPOCKETED_KNIGHT,
            new LootTable().addTable(1,
                    new LootItem(COINS_995, 50, 80, 1) //Coins
            )),
    WATCHMAN(65, 137.5, 386, 5, 3, "watchman's", PlayerCounter.PICKPOCKETED_KNIGHT,
            new LootTable().addTable(1,
                    new LootItem(COINS_995, 60, 90, 1) //Coins
            )),
    PALADIN(70, 151.75, 386, 5, 3, "paladin's", PlayerCounter.PICKPOCKETED_PALADIN,
            new LootTable().addTable(1,
                    new LootItem(COINS_995, 80, 120, 6), //Coins
                    new LootItem(562, 2, 3)   //Chaos runes
            )),
    GNOME(75, 198.5, 201, 5, 1, "gnome's", PlayerCounter.PICKPOCKETED_GNOME,
            new LootTable().addTable(1,
                    new LootItem(COINS_995, 300, 500, 16), //Coins
    ...
    HERO(80, 273.3, 386, 6, 4, "hero's", PlayerCounter.PICKPOCKETED_HERO,
            new LootTable().addTable(1,
                    new LootItem(COINS_995, 250, 400, 16),  //Coins
    ...
    ELF(85, 353.3, 422, 6, 5, "elf's", PlayerCounter.PICKPOCKETED_ELF,
            new LootTable().addTable(1,
                    new LootItem(COINS_995, 280, 500, 16), //Coins
    ...
    TZHAAR_HUR(90, 103.0, 2609, 6, 5, "tzhaar-hur's", PlayerCounter.PICKPOCKETED_TZHAAR_HUR,
            new LootTable().addTable(1,
                    ...
                    new LootItem(6529, 15, 30, 2),  //Tokkul
