...
public abstract class PlayerAttributes extends Entity {
    ...
    @Expose public boolean countcheck;
    ...
    @Expose public boolean broadcastBossEvent = false;
    @Expose public boolean broadcastActiveVolcano = false;
    @Expose public boolean broadcastHotspot = false;
    @Expose public boolean broadcastSupplyChest = false;
    @Expose public boolean broadcastBloodyMechant = false;
    @Expose public boolean broadcastAnnouncements = false;//Live Broadcasts.
    @Expose public boolean broadcastTournaments = false;
